 ...
 * Created on September 29, 2018, 11:02 AM
...
int main(int argc, char** argv) {
    ...
    hrsWrkd=30; //hours worked = 50
    
    //Process/Calculations Here
    switch (hrsWrkd<=ovrTime){ //question mark initiates (boolean)
        case true: grosPay = payRate*hrsWrkd;break;  // shoving dis cal in2 grospay
        default:   grosPay = ovrTime*payRate
