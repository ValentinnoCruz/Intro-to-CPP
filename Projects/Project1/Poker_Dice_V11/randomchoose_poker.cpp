...
//Winning Hands
         ...
         cout<<"       -Full house- – 3 dice of the same # and 2 dice with the same #"<<endl;
 ...
 //Initiate Game
    ...
    // declare the dice and sum the results
        ...
        if (Die1 ==1)
        {                 //symbol applied to die with given value
            cout<<"  ***********\n"
                   << "  * 9     9 *\n"
                   << "  * 9     9 *\n"
                   << "  * 9  9  9 *\n"
    ...
    //sum up variables per die
     ...
     cout<<"   ======================================="<<endl;
     cout<<"       You Rolled   "<<NumOF1s<<"    9's"<<endl;
     cout<<"       You Rolled   "<<NumOF2s<<"    10's"<<endl;
     cout<<"       You Rolled   "<<NumOF3s<<"    Jack's"<<endl;
     cout<<"       You Rolled   "<<NumOF4s<<"    Queen's"<<endl;
     cout<<"       You Rolled   "<<NumOF5s<<"    King's"<<endl;
     cout<<"       You Rolled   "<<NumOF6s<<"    Ace's"<<endl;
